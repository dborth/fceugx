...
int StateManager()
{
	...
	while ( quit == 0 )
	{
		...
		if ( j & PAD_BUTTON_A ) {
			redraw = 1;
			switch( menu ) {
				/*case 0 : CARDSLOT = CARD_SLOTA; MCManage(0); return 1; break;
				case 1 : CARDSLOT = CARD_SLOTA; MCManage(1); return 1; break;
				case 2 : CARDSLOT = CARD_SLOTB; MCManage(0); return 1; break;
				case 3 : CARDSLOT = CARD_SLOTB; MCManage(1); return 1; break;*/
				case 0 :
					slot ^= 1;
					break;
				case 1 : 
...
int mediacount = 3;
char mediamenu[3][30] = { 
	{ "Load from DVD" }, { "Load from SDCARD"}, { "Return to previous" } 
};
...
int ConfigScreen()
{
	...
	char credits[][512] = {
		...
		{ "Miscellaneous addons and spelling errors by KruLLo" },
		//{ " " },
		{ "Thank you to" },
