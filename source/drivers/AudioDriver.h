...
class AudioDriver
{
	public:
		...
		//! The emulator-core-facing audio backend (sample submission, DMA/rate
		//! control). Distinct from the voice/stream API below, which is used
		//! for menu sound effects and music rather than in-game emulator audio.
